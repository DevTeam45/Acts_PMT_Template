...
const Header = ({ onNote }) => {
  ...
  var finalName = filterName.includes("app")
    ...
    const handleChange = (checked) => {
      setChecked(checked);
      const newBackground = checked ? 'dark' : 'light';
      changeBackgroundBySwitch(newBackground);
    };
    ...
    <div className="header border-bottom">
      <div className="header-content">
        ...
        {/* Notifications */}
            ...
            <img src={userInfo.avatar ? userInfo.avatar : profile} width={20} alt="" />
						<div className="header-info ms-3">
							<span className="fs-18 font-w500 mb-2">{userInfo.firstName} {userInfo.surname}</span>
							<small className="fs-12 font-w400">{userInfo.email}</small>
						</div>
					</Dropdown.Toggle>
