    ...
    <div className="row page-titles mx-0">
		{ /* <div className="col-sm-6 p-md-0">
		  ...
		  <div className="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
			...
			<ol className="breadcrumb">
				<li className="breadcrumb-item active"><Link to={`/app/${path[path.length - 1]}`}>{motherMenu}</Link></li>
				<li className="breadcrumb-item  "><Link to={`/app/${path[path.length - 1]}`}>{activeMenu}</Link></li>
			</ol>
    </div>
  );
};
