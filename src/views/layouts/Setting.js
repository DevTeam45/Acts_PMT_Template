					...
					<div className="dlab-wrapper ">
						<div className="overlay-bx dlab-demo-bx ">
							<Link className="overlay-wrapper rounded-lg overlay-img" to={"#"}>
								<img src={demo1} alt="" className="w-100 " 
									onClick={() => setDemoTheme(1,'ltr')} data-theme="1" 
						...
						<div className="overlay-bx dlab-demo-bx ">
							<Link className="overlay-wrapper rounded-lg" to={"#"}>
								<img src={demo2} alt="" className="w-100" onClick={() => setDemoTheme(2,'ltr')} data-theme="2"  />
							</Link>
						...
						<div className="overlay-bx dlab-demo-bx ">
							<Link className="overlay-wrapper rounded-lg" to={"#"}>
								<img src={demo3} alt="" className="w-100" onClick={() => setDemoTheme(3,'ltr')}/>
							</Link>
						...
						<div className="overlay-bx dlab-demo-bx ">
							<Link className="overlay-wrapper rounded-lg" to={"#"}>
								<img src={demo4} alt="" className="w-100" onClick={() => setDemoTheme(4,'ltr')} data-theme="4"  />
							</Link>
						...
						<div className="overlay-bx dlab-demo-bx ">
							<Link className="overlay-wrapper rounded-lg" to={"#"}>
								<img src={demo5} alt="" className="w-100" onClick={() => setDemoTheme(5,'ltr')} data-theme="5" />
							</Link>
						...
						<div className="overlay-bx dlab-demo-bx ">
							<Link className="overlay-wrapper rounded-lg" to={"#"}>
								<img src={demo6} alt="" className="w-100" onClick={() => setDemoTheme(6,'ltr')} data-theme="6" />
							</Link>
