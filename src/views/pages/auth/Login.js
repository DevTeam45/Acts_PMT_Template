...
import { loadingToggleAction, loginAction } from '../../../redux/actions/AuthActions';
        ...
        <div className="authincation d-flex flex-column flex-lg-row flex-column-fluid">
            <div className="login-aside text-center d-flex flex-column flex-row-auto">
                <div className="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                    ...
                    <p>Change This In: <br /> /views/pages/auth/Login.js</p>
                </div>
                                ...
                                <div id="sign-in" className="auth-form form-validation">
                                    ...
                                    <form onSubmit={onLogin} className="form-validate">
                                        <h3 className="text-center mb-4 text-black">
                                            {props.showLoading && <div className="spinner-border text-primary" role="status">
                                    ...
                                    <div className="new-account mt-3">
                                        <p>Forgot your login details? <Link className="text-primary" to="/auth/forgot-password">Forgot Password</Link></p>
                                    </div>
                                </div>
                            </div>
                        </div>
