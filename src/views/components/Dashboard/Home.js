									...
									<div className="card">
										<div className="card-body">
											...
											<div className="mt-4 text-center">
												<h4 className="fs-20 font-w700">Workload Dashboard For Websites</h4>
								...
								<div className="card-body pt-0">
									<div className="row align-items-center">
										...
										<div className="col-xl-6 text-center">
											...
											<Link to={"#"} className="btn btn-outline-primary btn-rounded mb-sm-0 mb-2">Update Progress</Link>		
										</div>
									</div>
								</div>
							</div>
